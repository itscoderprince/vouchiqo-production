...
export default function AffiliateProductCard({ product }) {
  ...
  return (
    <div className="bg-white border border-slate-200/80 rounded-2xl p-3.5 sm:p-4 flex flex-col sm:flex-row gap-3.5 sm:items-center justify-between shadow-xs hover:shadow-md hover:border-blue-500/80 transition-all duration-200 text-left font-sans group">
      {/* Product Image & Badge */}
      <div className="relative w-full sm:w-28 h-28 sm:h-28 bg-slate-50 rounded-xl overflow-hidden shrink-0 border border-slate-100 flex items-center justify-center">
        {imageUrl ? (
      ...
      <div className="flex-1 min-w-0 space-y-1">
        <div className="inline-flex items-center bg-blue-50 border border-blue-100/80 text-blue-700 text-[9.5px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-md">
        ...
        <div className="flex items-center gap-2 pt-0.5">
          {hasExactPricing ? (
            ...
            <span className="text-sm sm:text-base font-extrabold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-200/80">
