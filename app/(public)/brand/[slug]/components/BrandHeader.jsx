...
export default function BrandHeader({
  ...
  return (
    <>
      ...
      <div className="relative w-full h-[170px] sm:h-[220px] md:h-[260px] lg:h-[290px] bg-gradient-to-r from-emerald-900/90 via-slate-900 to-teal-950 overflow-hidden select-none font-sans flex items-center justify-center">
        ...
        <div className="w-full px-2.5 sm:px-4 md:px-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2.5 sm:gap-3 relative">
            ...
            <div className="flex flex-row gap-3 sm:gap-4 items-end">
              ...
              <div className="relative z-10 rounded-2xl flex-shrink-0 flex items-center justify-center bg-white shadow-lg border-3 sm:border-4 border-white overflow-hidden w-[76px] h-[76px] sm:w-[92px] sm:h-[92px] md:w-[104px] md:h-[104px] -mt-9 sm:-mt-11 md:-mt-[52px] ring-1 ring-slate-200/60">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 pb-2 w-full sm:w-auto overflow-x-auto scrollbar-none font-sans -mx-1 px-1 sm:mx-0 sm:px-0 sm:flex-wrap">
              ...
              <button
                ...
                disabled={isRated}
                title={
                  isRated ? "Rating submitted" : "Click to rate this merchant"
                }
