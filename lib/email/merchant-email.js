...
export async function sendMerchantWelcomeEmail({
  ...
  const html = renderMerchantEmailLayout({
    ...
    bodyContent: `
      ...
      <div class="card" style="border: 1px solid #e2e8f0; background: #f8fafc; padding: 14px 16px; margin: 14px 0; border-radius: 4px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
          <tr>
            ...
            <td style="padding: 3px 0; color: #0f172a; font-weight: 700; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">${targetEmail}</td>
          </tr>
          ${
            password
              ? `
          <tr>
            ...
            <td style="padding: 3px 0; color: #0f172a; font-weight: 700; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">${password}</td>
          </tr>`
              : ""
          }
        </table>
