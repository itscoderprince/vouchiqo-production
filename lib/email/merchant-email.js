...
const FROM_MERCHANT_EMAIL =
  ...
  env.EMAIL_FROM_MERCHANT ||
  "Vouchiqo Merchant <merchant@vouchiqo.com>";
...
export async function sendMerchantWelcomeEmail({
  ...
  const html = renderMerchantEmailLayout({
    ...
    bodyContent: `
      <span class="badge badge-blue">⌛ Merchant Registration Received</span>
      ...
      <div class="card" style="border: 1px solid #cbd5e1; background: #ffffff; padding: 16px; margin: 16px 0; border-radius: 6px; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
        <div style="font-size: 12px; font-weight: 800; text-transform: uppercase; color: #0f172a; letter-spacing: 0.5px; margin-bottom: 8px; border-b: 1px solid #f1f5f9; pb: 4px;">🔑 Your Merchant Login Credentials</div>
