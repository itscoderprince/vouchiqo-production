...
<head>
  ...
  <style>
    ...
    .email-container { max-width: 580px; margin: 20px auto; background: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e2e8f0; }
    .email-header { background: #0f172a; border-top: 3px solid #e85d04; padding: 24px; text-align: center; }
    ...
    .cta-button { display: inline-block; background-color: #e85d04; color: #ffffff !important; font-weight: 700; font-size: 13px; text-decoration: none; padding: 10px 24px; border-radius: 4px; margin-top: 16px; text-align: center; }
    .email-footer { background-color: #f1f5f9; padding: 16px 20px; text-align: center; font-size: 11px; color: #64748b; border-top: 1px solid #e2e8f0; }
    .code-box { background: #f8fafc; border: 1px dashed #e85d04; padding: 12px; border-radius: 4px; font-family: monospace; font-size: 22px; font-weight: 800; color: #e85d04; letter-spacing: 2px; text-align: center; margin: 14px 0; }
  </style>
</head>
<body>
  <div class="email-container">
    <div class="email-header" style="background: #0f172a; border-top: 3px solid #e85d04; padding: 24px; display: table; width: 100%; box-sizing: border-box;">
