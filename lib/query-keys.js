...
const couponKeys = {
  /** Invalidation target for all coupon-related queries. */
  all: () => ["coupons"],
...
const userKeys = {
  claims: (status) => (status ? ["user-claims", status] : ["user-claims"]),
  savings: () => ["user-savings"],
  savedDeals: () => ["user-saved-deals"],
  revivals: () => ["customer-revivals"],
};
